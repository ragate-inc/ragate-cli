  ...
  var e = {
      ...
      4233: (e, t, a) => {
        ...
        function L(e) {
          const t = Object.assign({}, x, e),
            ...
            $ = t.errorProps.split(','),
            L = 'boolean' == typeof t.useOnlyCustomProps ? t.useOnlyCustomProps : 'true' === t.useOnlyCustomProps,
            N = w(t.customLevels),
            A = P(t.customLevels),
            q = t.customColors
              ? t.customColors.split(',').reduce((e, a) => {
                  const [r, s] = a.split(':'),
                    n = (L ? t.customLevels : void 0 !== A[r]) ? A[r] : m[r],
                    i = void 0 !== n ? n : r;
                  return e.push([i, s]), e;
                }, [])
              : void 0,
            C = { customLevels: N, customLevelNames: A };
          L && !t.customLevels && ((C.customLevels = void 0), (C.customLevelNames = void 0));
          ...
          return function (e) {
            ...
            if (o) {
              const e = ((L ? t.customLevels : void 0 !== A[o]) ? A[o] : m[o]) || Number(o);
              if (l[void 0 === n ? p : n] < e) return;
            }
            const w = y({ log: l, messageKey: s, colorizer: j, messageFormat: u, levelLabel: i, ...C, useOnlyCustomProps: L });
            ...
            const P = h({ log: l, colorizer: j, levelKey: n, prettifier: k.level, ...C }),
              ...
              N = _({ log: l, translateFormat: t.translateTime, timestampKey: c, prettifier: k.time });
            let q = '';
            if (
              (t.levelFirst && P && (q = `${P}`),
              N && '' === q ? (q = `${N}`) : N && (q = `${q} ${N}`),
        ...
        (e.exports = N), (e.exports.prettyFactory = L), (e.exports.colorizerFactory = l), (e.exports.default = N);
      },
      903: (e, t, a) => {
      ...
      385: (e, t, a) => {
        ...
        function N(e, t) {
          const a = x(t),
            r = a.pop();
          null !== (e = L(e, a)) && 'object' == typeof e && Object.prototype.hasOwnProperty.call(e, r) && delete e[r];
        }
        function A() {}
        function q(e, t) {
          e.destroyed ||
          ...
          prettifyMessage: function ({
            ...
            if (t && 'string' == typeof t) {
              const a = String(t).replace(/{([^{}]+)}/g, function (t, a) {
                let r;
                return a === s && void 0 !== (r = L(e, n)) ? ((o ? void 0 === i : void 0 === i[r]) ? h[r] : i[r]) : L(e, a) || '';
              });
              return r.message(a);
            }
